...
let process = {
	menu:function(){
		...
		let content = <div>
		    ...
		    <div align='center'>
						<img src='img/milkputo.jpg' width='50px' height='30px' />
						<img src='img/yema.jpg' width='50px' height='30px' />
						<img src='img/putobongbong.jpg' width='50px' height='30px' />
						<img src='img/suman.jpg' width='50px' height='30px' />
						<img src='img/tikoy.jpg' width='50px' height='30px' />
						<img src='img/pininat.jpg' width='50px' height='30px' />
						<img src='img/baye.jpg' width='50px' height='30px' />
			</div>
			<audio id="audio_bomb">
			...
			<p class="buttons-row">
				...
				<a href='#' class=" button button-fill color-black" onClick={process.page5}>SUMAN CASSAVA</a>
				<a href='#' class=" button button-fill color-black" onClick={process.page6}>TIKOY</a>
	...
	page2:function(){
		...
		let content = <div>
				...
				<div align='center'>
						<img src='img/putobongbong.jpg' width='80px' height='50px' />
					<p align='center'>
						<br/><div>INGREDIENTS</div>
	...
	page3:function(){
		...
		let content = <div>
				...
				<div align='center'>
						<img src='img/baye.jpg' width='80px' height='50px' />
	...
	page4:function(){
		...
		let content = <div>
			...
			<div align='center'>
						<img src='img/yema.jpg' width='80px' height='50px' />
					<p align='center'>
						<br/><div>INGREDIENTS</div>
	...
	page5:function(){
		process.audio('audio_bomb').play();
		let content = <div>
				<h2 align='center'>Suman Cassava</h2>
				<p class="buttons-row">
				<br/><a href='#' class="button button-fill color-blue" onClick={process.menu}>BACK</a>
				</p>
			<div align='center'>
						<img src='img/suman.jpg'  width='80px' height='50px' />
			...
			ReactDOM.render(content,documet.getElementById('root'));
		process.audio('audio_bomb').pause();
	},
page6:function(){
		process.audio('audio_bomb').play();
		let content = <div>
				<h2 align='center'>Tikoy</h2>
				<p class="buttons-row">
				<br/><a href='#' class="button button-fill color-blue" onClick={process.menu}>BACK</a>
				</p>
			<div align='center'>
